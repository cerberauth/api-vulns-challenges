...
This challenge demonstrates a JWT implementation that uses a weak HMAC secret.
...
```bash
# vulnerable: a short, dictionary-guessable HMAC secret is used
go run main.go serve --vulnerable=true

# fixed: a strong, high-entropy HMAC secret is used
...
Learn more about API security at Learn more about API security at [Cerberauth](https://www.cerberauth.com/)
